# Scoundrel++
## basato sull'omonimo ma aggiungendo le carte mancanti
- Assi neri 14 danni
- Asso cuori: refill vita?
- Asso Quadri: toglie 2 nemici da arma
- figure cuori: possono tenere una pozione sopra di se, vanno scartati insieme alla pozione all'uso, da decidere se tenere nella stanza o nel prprio slot dedicato, nel caso in cui debbano rimanere nella stanza possono tenere anche una eventuale arma con eventuali nemici? anche l'arma attuale?
- figure quadri: rimuovono 1nemico da arma
...
Tutte le carte evento, quando si incontrano, vanno affrontate per prime della stanza, si sostituiscono dopo essere affrontate e non si può fuggire dalla stanza successiva. Le carte evento sono i 2 joker e i 2 assi rossi 
  ...
  ## dubbi
  gli assi rossi? ha senso il modo in cui funzionano?
  i curatori (figure di cuori) sono forse op af?

  i joker spaccano sono troppo belli
